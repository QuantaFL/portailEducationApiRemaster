...
Route::prefix('v1')->middleware('auth:api')->group(function () {
        ...
        Route::post('grades/submit-term-notes/{class_id}', [GradeController::class, 'submitTermNotes']);Route::post('classes/{class_id}/notes/submit', [GradeController::class, 'submitTermNotes']);
